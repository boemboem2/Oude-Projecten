                    ...
                    <div class="panel-body">
                        ...
                        <div class="col-md-12">
                            <ul class="nav nav-tabs tabs-left">
                                ...
                                <li class=""><a href="#payment" data-toggle="tab" aria-expanded="false">Payment Informations</a>
				</li>
                                ...
                                <div class="tab-pane" id="payment">
                                    ...
                                    <form method="POST" action="{{action('SettingsController@paymentinfo')}}" class="form-horizontal form-label-left">
                                        ...
                                        <div class="item form-group">
                                            ...
                                            <div class="col-md-6 col-sm-6 col-xs-12">
                                                <input class="form-control col-md-7 col-xs-12" name="paypal_business" placeholder="Website Title" required="required" type="text" value="{{$setting[0]->paypal_business}}">
                                            </div>
                                        </div>
                                        <div class="item form-group">
					                    ...
					                    <div class="item form-group">
                                            ...
                                            <div class="col-md-6 col-sm-6 col-xs-12">
                                                <input class="form-control col-md-7 col-xs-12" name="feature_price" placeholder="Featured Profile Price" required="required" type="text" value="{{$setting[0]->feature_price}}">
                                            </div>
                                        </div>
                                ...
                                <div class="tab-pane" id="address">
                                    ...
                                    <form method="POST" action="settings/address" class="form-horizontal form-label-left" id="about_form">
                                        ...
                                        <div class="item form-group">
                                            ...
                                            <div class="col-md-6 col-sm-6 col-xs-12">
                                                <input id="name" class="form-control col-md-7 col-xs-12" data-validate-length-range="6" name="email" placeholder="Email Address"  type="text" value="{{$setting[0]->email}}">
                                            </div>
                                        </div>
                                        <div class="ln_solid"></div>
                                        <div class="form-group">
                                ...
                                <div class="tab-pane" id="footer">
                                    ...
                                    <form method="POST" action="settings/footer" class="form-horizontal form-label-left" id="footer_form">
                                        ...
                                        <div class="item form-group">
                                            ...
                                            <div class="col-md-6 col-sm-6 col-xs-12">
                                                <textarea rows="2" cols="60" id="footerpnael" class="form-control" name="footer">{{$setting[0]->footer}}</textarea>
                                            </div>
                                        </div>
