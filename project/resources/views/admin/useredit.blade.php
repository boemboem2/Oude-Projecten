        ...
        <div class="row" id="main">
            ...
            <div class="panel panel-default">
                <div class="panel-body">
                    ...
                    <div id="response"></div>
                    <form method="POST" action="{{ action('UsersController@update', ['id' => $user->id]) }}" class="form-horizontal form-label-left" enctype="multipart/form-data">
                        ...
                        <div class="item form-group">
                            ...
                            <div class="col-md-6 col-sm-6 col-xs-12">
                                <input class="form-control col-md-7 col-xs-12" value="{{$user->name}}" name="name" placeholder="Photographer Name" required="required" type="text">
                            </div>
                        </div>
                        <div class="item form-group">
                            ...
                            <div class="col-md-6 col-sm-6 col-xs-12">
                                <select name="category" class="form-control" required>
                                    <option value="">Select Photographer Category</option>
                        ...
                        <div class="item form-group">
                            ...
                            <div class="col-md-6 col-sm-6 col-xs-12">
                                <input class="form-control col-md-7 col-xs-12" name="specialities" value="{{$user->specialities}}" placeholder="Practice Areas" required="required" type="text">
                            </div>
                        </div>
                        <div class="item form-group">
                        ...
                        <div class="item form-group">
                            ...
                            <div class="col-md-6 col-sm-6 col-xs-12">
                                <input class="form-control col-md-7 col-xs-12" value="{{$user->email}}" name="email" placeholder="Email" required="required" type="text">
                            </div>
                        </div>
                        <div class="item form-group">
                        ...
                        <div class="form-group">
                            <div class="col-md-6 col-md-offset-3">
                                <button id="add_ads" type="submit" class="btn btn-success btn-block">Update Photographer</button>
                            </div>
                        </div>
                    </form>
                </div>
