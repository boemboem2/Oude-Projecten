    ...
    <ul class="nav navbar-right top-nav">
        ...
        <li class="dropdown">
            ...
            <ul class="dropdown-menu">
                <li><a href="{!! route('user.profile.edit') !!}"><i class="fa fa-fw fa-user"></i> Edit Profile</a></li>
                <li><a href="{!! route('user.changepassword') !!}"><i class="fa fa-fw fa-cog"></i> Change Password</a></li>
                <li class="divider"></li>
                <li>
                    <a href="{{ route('logout') }}"
