...
class SettingsController extends Controller
{
    ...
    public function paymentinfo(Request $request)
    {
        DB::table('settings')
            ->where('id', 1)
            ->update(['paypal_business' => $request->paypal_business,'stripe_key' => $request->stripe_key,'stripe_secret' => $request->stripe_secret,'normal_price' => $request->normal_price,'feature_price' => $request->feature_price]);
